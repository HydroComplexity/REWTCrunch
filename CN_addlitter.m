     function [CNa, ADD, CNo, OUT, ADD_bio, ADD_ex, ADD_net, Before_Bioturbation_ADD] = CN_addlitter (FORCING, PARAMS,...
...
% When harvest, Assumming all Corn root dies while MG, ans SG's root do not
ADDb = TBMLaNoLitterBack(day)*CR_ratio+RootDeathWhenHarvest(day);
