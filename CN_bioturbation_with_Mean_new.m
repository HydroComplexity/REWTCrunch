function [VARIABLES] = CN_bioturbation_with_Mean_new (PARAMS, VARIABLES...
    , CONSTANTS, FORCING, VERTSTRUC, SWITCHES, Cl, Cb, Ch, TBMla, CNvegtation, CNvegtation_root, Clpropotion)
